...
class A1:
    ...
    def calculate_openai_cost(self, input_tokens, output_tokens, model_name):
        # OpenAIの料金表
        pricing = {
            ...
            "gpt-5-mini-2025-08-07": {"input": 0.25 / 1000000, "output": 2.0 / 1000000},
        }
                    ...
                    async def async_tool_call():
                        ...
                        async with Client(transport) as client:
                            result = await client.call_tool(
                                tool_name, kwargs, raise_on_error=False
                            )
                        ...
                        #     print(f"JSON data: {content.json()}")
                        #     return content.json()
                        # print(f"Text data: {content.text}")
                        # return content.text
...
- Note on using R packages and Bash scripts:
  ...
  - Bash scripts and commands: Use the #!BASH marker in your execute block for both simple commands and complex shell scripts with variables, loops, conditionals, etc.
    ...
    def configure(self, self_critic=False, test_time_scale_round=0):
        ...
        def generate(state: AgentState) -> AgentState:
            ...
            if (
                ...
                self.token_usage_stats["call_count"] += 1

                # 費用計算
                cost = self.calculate_openai_cost(
                    input_tokens, output_tokens, self.llm.model_name
                )
    ...
    def go(self, prompt):
        ...
        return self.log, message.content, self.token_usage_stats
